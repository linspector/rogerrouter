 ...
 */
static void
free_ebook_data (struct ebook_data *ebook_data)
{
 ...
 */
void
free_ebook_list (GList *ebook_list)
{
 ...
 */
static ESource *
get_selected_ebook_esource (void)
{
  GList *list;
...
void
ebook_read_data (EClient *e_client)
{
  EBookClient *client;
  EBookQuery *query;
  char *sexp = NULL;
...
gboolean
evolution_remove_contact (RmContact *contact)
{
  EBookClient *client;
  gboolean ret = FALSE;
...
static void
evolution_set_image (EContact  *e_contact,
                     RmContact *contact)
{
...
gboolean
evolution_save_contact (RmContact *contact)
{
  EBookClient *client;
  EContact *e_contact;
  gboolean ret = FALSE;
...
gboolean
evolution_plugin_init (RmPlugin *plugin)
{
...
gboolean
evolution_plugin_shutdown (RmPlugin *plugin)
{
