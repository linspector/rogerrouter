...
static void
auth_uri_link_button_clicked_cb (GtkButton *button,
                                 gpointer   data)
{
...
static void
auth_code_entry_changed_cb (GtkEditable *entry,
                            gpointer     data)
{
...
#if 0
void
google_set_image (GDataContactsContact *gcontact,
...
gboolean
google_plugin_init (RmPlugin *plugin)
{
...
gboolean
google_plugin_shutdown (RmPlugin *plugin)
{
