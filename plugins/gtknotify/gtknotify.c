...
static
void on_pickup_clicked (GtkWidget *button, gpointer user_data)
{
...
static
void on_hangup_clicked (GtkWidget *button, gpointer user_data)
{
	GApplication *app = g_application_get_default();
...
static gpointer
gtknotify_show(RmConnection *connection, RmContact *contact)
{
	GtkWidget *window;
...
static void
gtknotify_update(RmConnection *connection, RmContact *contact)
{
}
