 ...
 */
static void
vox_stop_playback (VoxPlaybackData *playback)
{
 ...
 */
static void
vox_start_playback (VoxPlaybackData *playback)
{
  /* Reset scale range */
 ...
 */
static void
vox_media_button_clicked_cb (GtkWidget *button,
                             gpointer   user_data)
{
 ...
 */
static gboolean
vox_scale_change_value_cb (GtkRange      *range,
