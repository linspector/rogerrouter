 ...
 */
static gboolean
debug_log_idle (gpointer user_data)
{
 ...
 */
static gboolean
debug_delete_event_cb (GtkWidget *widget,
                       GdkEvent  *event,
                       gpointer   user_data)
{
 ...
 */
static void
debug_clear_clicked_cb (GtkWidget *widget,
                        gpointer   user_data)
{
 ...
 */
static void
debug_save_clicked_cb (GtkWidget *widget,
                       gpointer   user_data)
{
  GtkWidget *textview = user_data;
  GtkTextBuffer *text_buffer = gtk_text_view_get_buffer (GTK_TEXT_VIEW (textview));
