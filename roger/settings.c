 ...
 */
void
login_check_button_clicked_cb (GtkButton *button,
                               gpointer   user_data)
{
 ...
 */
void
ftp_login_check_button_clicked_cb (GtkButton *button,
                                   gpointer   user_data)
{
 ...
 */
void
login_password_entry_changed_cb (GtkEntry *entry,
                                 gpointer  user_data)
{
  RmProfile *profile = rm_profile_get_active ();
 ...
 */
void
ftp_password_entry_changed_cb (GtkEntry *entry,
                               gpointer  user_data)
{
  RmProfile *profile = rm_profile_get_active ();
 ...
 */
void
fax_report_directory_chooser_file_set_cb (GtkFileChooserButton *chooser,
                                          gpointer              user_data)
{
...
void
fax_report_switch_activate_cb (GtkSwitch *report_switch,
                               gboolean   state,
                               gpointer   user_data)
{
 ...
 */
void
filter_refresh_list (GtkListStore *list_store)
{
  GSList *list;
...
GtkWidget *
pref_group_create (GtkWidget *box,
                   gchar     *title_str,
                   gboolean   hexpand,
                   gboolean   vexpand)
{
 ...
 */
static void
type_box_changed_cb (GtkWidget *widget,
                     gpointer   next)
{
 ...
 */
static void
type_box_changed_cb2 (GtkWidget *widget,
                      gpointer   rule_ptr)
{
 ...
 */
static void
sub_type_box_changed_cb (GtkWidget *widget,
                         gpointer   rule_ptr)
{
  RmFilterRule *rule = rule_ptr;
...
/* Forward declaration */
static void pref_filters_add_rule (gpointer      grid_ptr,
                                   RmFilterRule *rule);
 ...
 */
static void
pref_filters_add_rule (gpointer      grid_ptr,
                       RmFilterRule *rule)
{
  GtkWidget *grid = grid_ptr;
  GtkWidget *own_grid;
 ...
 */
void
filter_edit_button_clicked_cb (GtkWidget *widget,
                               gpointer   data)
{
 ...
 */
void
filter_remove_button_clicked_cb (GtkWidget *widget,
                                 gpointer   data)
{
  GtkTreeIter selected_iter;
  GtkTreeModel *model;
 ...
 */
void
filter_add_button_clicked_cb (GtkWidget *widget,
                              gpointer   data)
{
  GtkWidget *dialog;
  GtkWidget *grid;
...
static void
set_checkbutton_buttons (gboolean state)
{
...
void
action_refresh_list (GtkListStore *list_store)
{
...
void
settings_destroy_cb (GtkWidget *widget,
                     gpointer   user_data)
{
...
void
settings_refresh_list (GtkListStore *list_store)
{
...
void
action_enable_renderer_toggled_cb (GtkCellRendererToggle *toggle,
                                   gchar                 *path_str,
                                   gpointer               user_data)
{
...
void
action_apply_button_clicked_cb (GtkWidget *button,
                                gpointer   user_data)
{
}

gboolean
action_edit (RmAction *action)
{
  GtkWidget *dialog;
...
void
actions_add_button_clicked_cb (GtkWidget *widget,
                               gpointer   data)
{
  if (action_edit (NULL)) {
...
void
actions_remove_button_clicked_cb (GtkWidget *widget,
                                  gpointer   data)
{
  GtkTreeIter selected_iter;
  GtkTreeModel *model;
...
void
actions_edit_button_clicked_cb (GtkWidget *widget,
                                gpointer   data)
{
  GtkTreeIter selected_iter;
  GtkTreeModel *model;
...
gboolean
actions_treeview_cursor_changed_cb (GtkTreeView *view,
                                    gpointer     user_data)
{
...
gboolean
actions_treeview_button_press_event_cb (GtkTreeView    *view,
...
void
action_checkbutton_toggled_cb (GtkToggleButton *button,
                               gpointer         user_data)
{
  guint flags = 0;
 ...
 */
void
audio_plugin_combobox_changed_cb (GtkComboBox *box,
                                  gpointer     user_data)
{
  GSList *devices;
  gchar *active;
...
GtkWindow *
settings_get_window (void)
{
  return settings ? GTK_WINDOW (settings->window) : NULL;
}

void
settings_fill_address_book_plugin_combobox (struct settings *settings)
{
  GSList *plugins;
  GSList *list;
...
void
settings_notification_outgoing_toggled_cb (GtkCellRendererToggle *toggle,
                                           gchar                 *path_str,
                                           gpointer               user_data)
{
...
void
settings_notification_incoming_toggled_cb (GtkCellRendererToggle *toggle,
                                           gchar                 *path_str,
                                           gpointer               user_data)
{
  GtkListStore *liststore = user_data;
...
void
phone_settings_close_button_cb (GtkWidget *button,
                                gpointer   user_data)
{
...
void
phone_plugin_settings_button_clicked_cb (GtkWidget *button,
                                         gpointer   user_data)
{
...
void
settings_numbers_device_combobox_changed_cb (GtkComboBox *box,
                                             gpointer     user_data)
{
...
void
settings_notification_combobox_changed_cb (GtkComboBox *box,
                                           gpointer     user_data)
{
  RmProfile *profile = rm_profile_get_active ();
  gchar *number = user_data;
...
void
settings_numbers_populate (GtkWidget *listbox)
{
  RmProfile *profile;
  gchar **numbers;
  gint idx;
...
void
settings_notification_populate (GtkWidget *list_box)
{
  RmProfile *profile = rm_profile_get_active ();
...
void
fax_ghostscript_file_chooser_button_file_set_cb (GtkWidget *button,
                                                 gpointer   user_data)
{
  RmProfile *profile = rm_profile_get_active ();
...
void
phone_active_switch_activate_cb (GtkSwitch *widget,
                                 gpointer   user_data)
{
...
void
fax_active_switch_activate_cb (GtkSwitch *widget,
                               gpointer   user_data)
{
  rm_profile_update_numbers (rm_profile_get_active ());
}
...
void
numbers_header_func (GtkListBoxRow *row,
...
void
phone_msn_changed_cb (GtkWidget *widget,
                      gpointer   user_data)
{
  RmProfile *profile = rm_profile_get_active ();
...
void
fax_msn_changed_cb (GtkWidget *widget,
                    gpointer   user_data)
{
  RmProfile *profile = rm_profile_get_active ();
