 ...
 */
static void
plugins_url_button_clicked_cb (GtkWidget *widget,
                               gpointer   user_data)
{
  GError *error = NULL;
  gchar *uri = user_data;
 ...
 */
static void
plugins_about_button_clicked_cb (GtkWidget *button,
                                 gpointer   user_data)
{
 ...
 */
static void
plugins_help_button_clicked_cb (GtkWidget *button,
                                gpointer   user_data)
{
  GtkListBoxRow *row = gtk_list_box_get_selected_row (GTK_LIST_BOX (user_data));
  GtkWidget *child = gtk_container_get_children (GTK_CONTAINER (row))->data;
 ...
 */
static void
plugins_listbox_row_selected_cb (GtkListBox    *box,
                                 GtkListBoxRow *row,
                                 gpointer       user_data)
{
  GtkWidget *child;
